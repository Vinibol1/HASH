...
void hash_insertar_pruebas_claves_iguales()
{
	...
	pa2m_afirmar(*(int*)hash_buscar(hash,clave2) == valor2, "La función encontro el elemento correctamente");
	pa2m_afirmar(hash_insertar(hash,clave3,&valor3,NULL) == true, "hash devolvio true");
	pa2m_afirmar(*(int*)hash_buscar(hash,clave2) == valor3, "La función encontro el elemento correctamente");
	pa2m_afirmar(hash_cantidad(hash) == 2, "La función tiene 2 elementos");
	pa2m_afirmar(hash_contiene(hash,clave) == true, "La función encontro la clave correctamente");
	pa2m_afirmar(hash_contiene(hash,clave2) == true, "La función encontro la clave correctamente");
	pa2m_afirmar(hash_contiene(hash,clave3) == true, "La función encontro la clave correctamente");
	pa2m_afirmar(*(int*)hash_buscar(hash,clave) == valor, "La función encontro el elemento correctamente %i",*(int*)hash_buscar(hash,clave));
	hash_destruir(hash);
}
...
void hash_quitar_pruebas()
{
	...
	pa2m_afirmar(*(int*)hash_quitar(hash,clave5) == valor5, "hash devolvio valor 5");
	pa2m_afirmar(hash_cantidad(hash) == 4, "La función tiene 4 elementos");
	pa2m_afirmar(*(int*)hash_quitar(hash,clave4) == valor4, "hash devolvio valor 4");
	pa2m_afirmar(hash_cantidad(hash) == 3, "La función tiene 3 elementos");
	pa2m_afirmar(*(int*)hash_quitar(hash,clave3) == valor3, "hash devolvio valor 3");
	pa2m_afirmar(hash_cantidad(hash) == 2, "La función tiene 2 elementos");
	pa2m_afirmar(*(int*)hash_quitar(hash,clave2) == valor2, "hash devolvio valor 2");
	pa2m_afirmar(hash_cantidad(hash) == 1, "La función tiene 1 elementos");
	pa2m_afirmar(*(int*)hash_quitar(hash,clave) == valor, "hash devolvio valor 1");
...
void hash_iterar_pruebas()
{
	...
	pa2m_afirmar(iterador == 5, "La función iterar itera %i de 5 elementos",iterador);
	pa2m_afirmar(*(int *)hash_buscar(hash,"daa") == 4, "La función iterar sumo 2 al elemento");
	pa2m_afirmar(*(int *)hash_buscar(hash,"asd0") == 4, "La función iterar sumo 2 al elemento");
	pa2m_afirmar(*(int *)hash_buscar(hash,"asd1") == 4, "La función iterar sumo 2 al elemento");
	pa2m_afirmar(*(int *)hash_buscar(hash,"asd2") == 4, "La función iterar sumo 2 al elemento");
	pa2m_afirmar(*(int *)hash_buscar(hash,"asd3") == 4, "La función iterar sumo 2 al elemento");
...
void hash_iterar_terminando_el_iterador_forzadamente_pruebas()
{
	...
	pa2m_afirmar(iterador == 4, "La función iterar itera %zu de 5 elementos",iterador);
	pa2m_afirmar(*(int *)hash_buscar(hash,"daa") == 2, "La función iterar sumo 2 al elemento");
	pa2m_afirmar(*(int *)hash_buscar(hash,"asd0") == 4, "La función iterar sumo 2 al elemento");
	pa2m_afirmar(*(int *)hash_buscar(hash,"asd1") == 4, "La función iterar sumo 2 al elemento");
	pa2m_afirmar(*(int *)hash_buscar(hash,"asd2") == 3	, "La función iterar sumo 2 al elemento");
	pa2m_afirmar(*(int *)hash_buscar(hash,"asd3") == 4, "La función iterar sumo 2 al elemento");
	hash_destruir(hash);
}
